...
**Linear Algebra 정리 시리즈** · 18/19 · [← 이전: Spectral Decomposition과 행렬의 구조](/posts/linear-algebra-17-spectral-decomposition/) · [다음: Least Squares Solution과 데이터 근사 →](/posts/linear-algebra-19-least-squares/)
